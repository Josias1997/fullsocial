                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                <td style="padding-right: 0px;padding-left: 0px;"
                                                                    ...
                                                                    <amp-img alt="Image"
                                                                        src="https://assets.unlayer.com/projects/165672/1686305160770-105665.png"
                                                                        width="200" height="200" layout="intrinsic"
                                                    ...
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="font-size: 14px; line-height: 140%;">
                                                                <strong>@yield('introduction')</strong>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="font-size: 14px; line-height: 140%;"><span
                                                                    style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                            style="line-height: 39.2px; font-size: 28px;">@yield('title')</span></strong>
                                                                </span>
                                                            </p>
                                                        </div>
